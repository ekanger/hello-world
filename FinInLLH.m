...
subplot(3,1,1)
plot (newTime(2:iterations),LLH_error(1,2:iterations))
xlabel ('[s] seconds')
ylabel('[deg] degrees')
legend ('The error in lattitude angle over time')

subplot (3,1,2)
plot (newTime(2:iterations),LLH_error(2,2:iterations))
xlabel ('[s] seconds')
ylabel('[deg] degrees')
legend ('The error in longitude angle over time')

subplot (3,1,3)
plot (newTime(2:iterations),LLH_error(3,2:iterations))
xlabel ('[s] seconds')
ylabel('[m] meters')
legend ('The error in height over time')
